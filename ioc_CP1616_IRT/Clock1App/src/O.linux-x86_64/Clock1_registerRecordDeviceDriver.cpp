...
/* Generated from ../O.Common/Clock1.dbd */
...
epicsShareExtern dset *pvar_dset_cp1616Ai;
...
epicsShareExtern dset *pvar_dset_cp1616Ao;
...
epicsShareExtern drvet *pvar_drvet_cp1616;
...
int Clock1_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/BigH_NSRL/s7testioc/epcis/modules/ioc_Clock_IRT";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"Clock1_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    Clock1_registerRecordDeviceDriver(*iocshPpdbbase);
}
